                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3 text-center">
                            <img alt="" src="http://www.reginacustombookkeeping.com/wp-content/uploads/2011/04/faq.jpg" style="width:150px;height:150px" class="img-rounded">
                        </div>
                        <div class="col-md-10 col-sm-9">
                            <div class="row">
                                <div class="col-xs-9">
                                    <p>Question: <c:out value="${faq.question}"/></p>
                                    <p>Answer: <c:out value="${faq.answer}"/></p>
